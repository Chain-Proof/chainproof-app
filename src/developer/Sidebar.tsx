...
import { FiHome, FiKey, FiCode, FiDollarSign, FiSettings, FiLogOut } from 'react-icons/fi';
...
const Sidebar: React.FC<SidebarProps> = ({ onLogout }) => {
  ...
  const menuItems = [
    ...
    { path: '/developer/api-keys', icon: FiKey, label: 'API Keys' },
  ...
  return (
    <aside className="w-64 flex flex-col" style={{ backgroundColor: '#181824' }}>
      {/* Logo */}
